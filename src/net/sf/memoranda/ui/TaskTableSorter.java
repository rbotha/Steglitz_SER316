	...
	Comparator comparator = new Comparator(){
		public int compare(Object o1, Object o2){
			...
			switch(sorting_column){
				...
				case 2: return (int)(task1.getEffort() - task2.getEffort());
				case 3: return (int)(task1.getActualEffort() - task2.getActualEffort());
				case 4: return task1.getStartDate().getDate().compareTo(task2.getStartDate().getDate());
				case 5: return task1.getEndDate().getDate().compareTo(task2.getEndDate().getDate());
				case 0: // task priority, same as 4
				case 6: return task1.getPriority() - task2.getPriority();
				case 7: return task1.getStatus( CurrentDate.get() ) - task2.getStatus( CurrentDate.get() );
				case 8: return task1.getProgress() - task2.getProgress();
			}
